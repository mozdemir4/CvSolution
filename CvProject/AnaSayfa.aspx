<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="CvProject.AnaSayfa" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <p class="top_hdp mt-2">Bu sitede benimle ilgili bilgileri görmektesiniz.</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        <li class="active"><a href="AnaSayfa.aspx" class="scroll">Cv Sitesi</a></li>
                          <li class="mt-sm-3"><a href="#about" class="scroll">Eğitim Hayatı</a></li>
                                ...
                                <li class="mt-sm-3"><a href="AIstatistik.aspx" class="scroll">Admin Sayfası</a></li>
                    </ul>
    ...
    <div class="main">
            ...
            <div class="container">
                <div class="mx-auto text-center">
                    ...
                    <p class="banp mx-auto mt-3">
                        <asp:Repeater ID="AdRepeat" runat="server">
                            <ItemTemplate>
                                <%#Eval("BILGILER") %>
                            </ItemTemplate>
                        </asp:Repeater>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <p class="iner mt-md-5">
                <asp:Repeater ID="EgıtımRepeat" runat="server">
                    <ItemTemplate>
                        <%#Eval("EGITIM")%>
                    </ItemTemplate>
                </asp:Repeater>
        ...
        <div class="news" id="news">
            ...
            <p class="iner mt-md-5 text-left">
                <asp:Repeater ID="DeneyımRepeat" runat="server">
                    <ItemTemplate><%#Eval("ISDENEYIMI") %></ItemTemplate>
                </asp:Repeater>
            </p>
        </div>
        <!-- //news -->
